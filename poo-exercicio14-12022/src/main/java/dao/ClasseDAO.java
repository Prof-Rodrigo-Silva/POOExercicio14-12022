...
public class ClasseDAO {
	...
	public List<BeanAlunoTelefone> listarAlunoFone(Long idAluno) throws Exception {

		List<BeanAlunoTelefone> list = new ArrayList<BeanAlunoTelefone>();
		...
		while (resultado.next()) {
			BeanAlunoTelefone beanAlunoFone = new BeanAlunoTelefone();
	...
	public void deletarCascata(Long id) {
		try {
			...
			String sqlaluno = "DELETE FROM aluno WHERE id = "+id;
	...
	public String ultimoRegistro() throws SQLException {
		...
		String sql = "SELECT * FROM aluno ORDER BY id DESC LIMIT 1";
